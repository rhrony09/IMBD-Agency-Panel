<header class="main-header">
  ...
  <a href="home.php" class="logo">
    ...
    <span class="logo-lg"><b>IMBD Panel</b></span>
  </a>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?php echo (!empty($user['photo'])) ? './library/images/' . $user['photo'] : './library/images/profile.jpg'; ?>" class="user-image" alt="User Image">
